...
exports.run = async (client, message, args) => {
  ...
  if(slm === "durdur" || slm === "kapat" || slm === "sıfırla") {
    if(!ip) return message.channel.send(`<a:tik:740278047890210846> **_Resimli Hoşgeldin/Görüşürüz kanalı zaten ayarlı değil_**!`)
    db.delete(`giriş_${message.guild.id}`)
    message.channel.send(`<a:tik5:740278115661774970> **_Resimli Hoşgeldin sistemi başarıyla kapalı hale getirildi_**!`)
    return
  }
