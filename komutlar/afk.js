...
exports.run = async (client, message, args) => {
  ...
  if (!args[0]) {
    ...
    await db.set(`afkSebep_${message.author.id}_${message.guild.id}`,"Belirtilmemiş");
 ...
 const embedd = new Discord.MessageEmbed().setDescription(`\`[${a}]\` **Sebebiyle afk moduna giriş yaptınız.**`)
